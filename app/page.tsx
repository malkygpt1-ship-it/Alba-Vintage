...
const suppliers = [
  { name: 'Diamond Vintage', categories: 'Button-up shirts · Ralph Lauren · Tommy Hilfiger · Lacoste · Trench coats', rating: '4.5', repeat: 345, dispatch: '6 days', url: 'https://www.joinfleek.com/vendor/diamond-vintage', tag: 'Branded men’s', confidence: 'High' },
  { name: 'Vintage Central', categories: 'Polo shirts · Lululemon', rating: '4.9', repeat: 372, dispatch: '5 days', url: 'https://www.joinfleek.com/vendor/vintage-central', tag: 'Polo / activewear', confidence: 'High' },
  { name: 'Thrift Drip', categories: 'Track pants · Nike · Adidas · Umbro', rating: '4.6', repeat: 80, dispatch: '4 days', url: 'https://www.joinfleek.com/vendor/thrift-drip', tag: 'Sportswear', confidence: 'High' },
  { name: 'Retro Fashion', categories: 'Puffer jackets · Retro / Y2K fashion', rating: '4.5', repeat: 56, dispatch: '3 days', url: 'https://www.joinfleek.com/vendor/retro-fashion', tag: 'Jackets', confidence: 'Medium' },
  { name: 'Thrift Kings', categories: 'Workwear · Carhartt · Dickies', rating: '4.4', repeat: 201, dispatch: '3 days', url: 'https://www.joinfleek.com/vendor/thrift-kings', tag: 'Workwear', confidence: 'High' },
  { name: 'Asian Trader', categories: 'Hip-hop jeans · Japanese / Y2K denim · Carhartt · Dickies', rating: '4.5', repeat: 14, dispatch: '—', url: 'https://www.joinfleek.com/vendors?search=Asian%20Trader', tag: 'Baggy denim', confidence: 'Test' },
  { name: 'Trade Vintage', categories: 'Denim shorts', rating: '4.6', repeat: 92, dispatch: '7 days', url: 'https://www.joinfleek.com/vendor/trade-vintage', tag: 'Denim shorts', confidence: 'High' },
  { name: 'Legacy Vintage', categories: 'Miniskirts · Y2K denim · Hip-hop / baggy jorts', rating: '4.8', repeat: 63, dispatch: '6 days', url: 'https://www.joinfleek.com/vendor/legacy', tag: 'Y2K denim', confidence: 'High' },
  { name: 'Vintage Master', categories: 'Denim skirts', rating: '5.0', repeat: 77, dispatch: '3 days', url: 'https://www.joinfleek.com/vendor/mohsin-fashion-bazar', tag: 'Denim skirts', confidence: 'High' },
  { name: 'The Ethereal Wardrobe', categories: 'Cami tops · Nike · Y2K', rating: '4.8', repeat: 222, dispatch: '2 days', url: 'https://www.joinfleek.com/vendor/ethereal', tag: 'Y2K / Nike', confidence: 'High' },
  { name: 'Retro Thrift Store', categories: 'General Y2K · Coach bags', rating: '4.7', repeat: 478, dispatch: '3 days', url: 'https://www.joinfleek.com/vendor/retro-thrift-store-1', tag: 'Y2K / bags', confidence: 'High' },
  { name: 'its pre-loved', categories: 'General Y2K', rating: '4.3', repeat: 250, dispatch: '—', url: 'https://www.joinfleek.com/vendors?search=its%20pre-loved', tag: 'Y2K', confidence: 'Test' },
  { name: 'MH Vintage', categories: 'Single-stitch T-shirts', rating: '4.7', repeat: 273, dispatch: '4 days', url: 'https://www.joinfleek.com/vendor/mh-vintage-2', tag: 'Vintage tees', confidence: 'High' },
  { name: 'Vintage Visions', categories: 'Vintage band tees', rating: '4.8', repeat: 173, dispatch: '2 days', url: 'https://www.joinfleek.com/vendor/vintage-visions', tag: 'Band tees', confidence: 'High' },
  { name: 'Vintage Storm', categories: 'Ralph Lauren · branded vintage', rating: '4.6', repeat: 514, dispatch: '7 days', url: 'https://www.joinfleek.com/vendor/vintage-storm', tag: 'Ralph Lauren', confidence: 'High' },
  { name: 'Creed Vintage', categories: 'Miss Me · True Religion · Rock Revival · Y2K denim', rating: '4.8', repeat: 1379, dispatch: '4 days', url: 'https://www.joinfleek.com/vendor/creed-vintage', tag: 'Premium Y2K denim', confidence: 'Very high' },
]
